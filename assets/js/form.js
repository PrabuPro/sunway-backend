...
$(document).ready(function () {
 ...
 $(document).ready(function () {
 	$('.addTour_form').on('submit', function (e) {
		 e.preventDefault();
		 
		 let about = document.querySelector('input[name=introduction]');
		 about.value = JSON.stringify(quill.getContents());

		 console.log("Submitted", $('.addTour_form').serialize(), $('.addTour_form').serializeArray());
 		...
 		$.ajax({
 			type: 'POST',
 			url: 'tourcontroller/addtours',
 			data: $('.addTour_form').serialize(),
 			datatype: "html",
