  <section class="home-slider owl-carousel">
    ...
    <section class="ftco-section">
      <div class="container">
        <div class="row">
          <div class="col-lg-8">
            <h2 class="mb-5 pb-3" style="font-size:24px; font-weight:600; text-transform:capitalize;"><?php if(isset($suitable)){ echo  $hotel_type . ' for ' . $suitable ;  } else if (isset($hotel_type)){ echo urldecode($hotel_type) ; } else { echo "All Types"; }?></h2>
            <div class="row">
