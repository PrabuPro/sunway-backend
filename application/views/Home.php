...
<section class="home-slider owl-carousel">
	<div class="slider-item"
		style="background-image: url('<?php echo base_url();?>assets/images/hbg_1.jpg');  background-size:cover;">
	...
	<div class="slider-item"
		style="background-image: url('<?php echo base_url();?>assets/images/hbg_2.jpg');  background-size:cover;">
		<div class="overlay"></div>
		<div class="container">
			<div class="row slider-text align-items-center">
	...
	<div class="slider-item"
		style="background-image: url('<?php echo base_url();?>assets/images/hbg_3.jpg'); background-size:cover;">
		<div class="overlay"></div>
		<div class="container">
			<div class="row slider-text align-items-center">
				<div class="col-md-7 col-sm-12 ftco-animate">
			...
			<div class="col-md-12 tabulation-search">
				<div class="element-animate">
					<div class="nav nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						<a class="nav-link p-3 active" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile"
				...
				<div class="tab-content py-4" id="v-pills-tabContent">
								...
								<div class="fields d-block d-lg-flex">
									...
									<div class="select-wrap one-third">
										...
										<select name="suitable_for" id="" class="form-control form-control-select">
											...
											<option value="family" class="form-control-option-white">Family with Children</option>
											<option value="singles + kids" class="form-control-option-white">Small Groups</option>
										</select>
									</div>
									<div class="select-wrap one-third">
										<div class="icon"></div>
										<select name="tour_type" id="" class="form-control" required>
											...
											<option value="eco" class="form-control-option-white">Eco and Wildlife</option>
											<option value="adventure" class="form-control-option-white">Adventure</option>
											<option value="active" class="form-control-option-white">Actively Explore</option>
							...
							<form action="" method="post" class="d-block d-lg-flex">
								<div class="fields d-block d-lg-flex">
									<div class="textfield-search one-third"><input type="text" class="form-control"
											placeholder="Search Location"></div>

									<div class="check-in one-third"><input type="text" id="start_date" class="form-control"
											placeholder="Start date"></div>

									<div class="check-out one-third"><input type="text" id="return_date" class="form-control"
											placeholder="Return date"></div>
									<div class="select-wrap one-third">
					...
					<div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
						<div class="block-17">
							<form action="" method="post" class="d-block d-lg-flex">
								<div class="fields d-block d-lg-flex">
									<div class="textfield-search one-third one-third-1"><input type="text" class="form-control"
											placeholder="Search Location"></div>

									<div class="check-out one-third one-third-1"><input type="text" id="start_date" class="form-control"
											placeholder="Check-out date"></div>
		...
		<div class="row ">
			<div class="col-md-12 col-lg-12 text-center heading-section ftco-animate">
				...
				<h4 class="tailorMadePage__para" style='padding:0 4em 0 4em;'>
					Sri Lankan based Destination management company which caters to all type of travelers around the world, our
					local experts know how to make your holiday unique and special, whatsoever your interest are Sunway is there
					to drop you at your dream destination. Backed with first hand local knowledge combined with professional
					experience of more than 25 years Sunway will always prioritize clients’ preference. We know how to design a
					perfect vacation for you right here in Sri Lanka. Whoopee for a stress free travel with Sunway !
			</div>
		</div>
	</div>
</div>
		...
		<div class="row">
			<div class="col-md-6 col-lg-4 d-flex align-self-stretch ftco-animate">
				<div class="media block-6 services d-block text-center">
					<div class="d-flex justify-content-center">
						<div class="icon d-flex justify-content-center mb-3"><span class="align-self-center"><img
									src="assets/images/personalized2.png" alt=""></span></div>
					</div>
			...
			<div class="col-md-6 col-lg-4 d-flex align-self-stretch ftco-animate">
				<div class="media block-6 services d-block text-center">
					<div class="d-flex justify-content-center">
						<div class="icon d-flex justify-content-center mb-3"><span class="align-self-center"><img
									src="assets/images/designer.png" alt=""></span></div>
					</div>
					<div class="media-body p-2">
			...
			<div class="col-md-6 col-lg-4 d-flex align-self-stretch ftco-animate">
				<div class="media block-6 services d-block text-center">
					<div class="d-flex justify-content-center">
						<div class="icon d-flex justify-content-center mb-3"><span class="align-self-center"><img
									src="assets/images/tie.png" alt=""></span></div>
					</div>
					<div class="media-body p-2">
		...
		<div class="row">
			<div class="col-md-6 col-lg-4 d-flex align-self-stretch ftco-animate">
				<div class="media block-6 services d-block text-center">
					<div class="d-flex justify-content-center">
						<div class="icon d-flex justify-content-center mb-3"><span class="align-self-center"><img
									src="assets/images/airplane.png" alt=""></span></div>
					</div>
					<div class="media-body p-2">
						<h3 class="heading">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Travel with peace of
							mind&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h3>
					</div>
				</div>
			</div>
			<div class="col-md-6 col-lg-4 d-flex align-self-stretch ftco-animate">
				<div class="media block-6 services d-block text-center">
					<div class="d-flex justify-content-center">
						<div class="icon d-flex justify-content-center mb-3"><span class="align-self-center"><img
									src="assets/images/label.png" alt=""></span></div>
					</div>
					<div class="media-body p-2" style="margin: auto !important;">
						<h3 class="heading" style="margin: auto !important;">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Middleman free
							prices&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h3>
					</div>
				</div>
			...
			<div class="col-md-6 col-lg-4 d-flex align-self-stretch ftco-animate" style="padding:auto;">
				<div class="media block-6 services d-block text-center">
					<div class="d-flex justify-content-center">
						<div class="icon d-flex justify-content-center mb-3"><span class="align-self-center"><img
									src="assets/images/give-love.png" alt=""></span></div>
					</div>
					<div class="media-body p-2">
						<h3 class="heading" style="margin:auto;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Responsible &
							Sustainable&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h3>
					</div>
				</div>
			</div>
...
<section class="ftco-section">
	<div class="container-fluid">
		...
		<div class="row">
			<h3 class="col-lg-12 sub--para mb-5 ftco-animate">We design each tour with passion and attention to detail, to
				make them spectacular and unique. To make it easy for you to select your forte, we have embedded collections of
				distinctive holiday plans to most sought after holiday themes. </h3>
		...
		<div class="row no-gutters">
			...
			<div class="col-md-6 col-lg-3 ftco-animate">
				<a href="<?php echo base_url(); ?>search-tours/eco" class="block-5"
					style="background-image: url('<?php echo base_url();?>assets/images/eco.jpg');">
					<div class="text">
			...
			<div class="carousel1 owl-carousel ftco-owl">
				...
				<div class="item">
					<div class="blog-entry">
						<a href="<?php echo base_url() .'tours/'.$suggestion->tour_id;?>" class="block-20"
							style="background-image: url('<?php echo base_url().'assets/images/tours/'.$suggestion->photo_id; ?>');">
						</a>
						<div class="text p-4">

							<h3 class="heading"><a
									href="<?php echo base_url() .'tours/'.$suggestion->tour_id;?>"><?php echo $suggestion->name; ?></a>
							</h3>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-12 col-lg-6 col-sm-12">
				...
				<a href="<?php echo base_url(); ?>search-tours/family">
					<div class="banner-image" style="background-image: url('<?php echo base_url();?>assets/images/uk.jpg'); ">
					</div>
				</a>
			</div>

			<div class="col-md-12 col-lg-6 col-sm-12">
				<a href="<?php echo base_url(); ?>search-tours/ramadan">
					<div class="banner-image" style="background-image: url('<?php echo base_url();?>assets/images/ramadan.jpg');">
					</div>
				</a>
			</div>
		</div>
...
<div class="parallax-window" data-parallax="scroll" data-image-src="<?php echo base_url(); ?>assets/images/weather.jpg"
	style="min-height: 580px; background: transparent; transform: scaleX(-1); ">
	
	<div class="parallax-box-home" id="parallax-box-home" style="transform: scaleX(-1); height: 25em;">
    <div class="parallax-box-home--text"></div>
    <img src="<?php echo base_url(); ?>assets/images/rain.svg" class="parallax-box-home--icon" alt="">
    <h3 class="parallax-box-home--text-2"></h3>
    
		<div class="parallax-box-home-section-2">
	...
	<div class="parallax-window-content">
		<h4 class="parallax-window-temp-heading">Temperature in Sri Lanka Right Now!</h4>
		<h1 class="parallax-window-temp"></h1>
		<h1 class="parallax-window-forecast"></h1>
	</div>
</div>
	...
	<div class="container">
		...
		<div class="row ftco-animate justify-content-center">
			<div class="carousel owl-carousel ftco-owl" style="margin: 4em;">
				<div class="item">
					<div class="box_card " style="background-color: #684967;">
						<div class="box_card__text">
							<div class="box_card__text--number">
								<h3 class="box_card__text--number-text">1</h3>
							</div>
							<h3 class="box_card__text--heading" style="color:#ffffff;">Step 1</h3>
							<div class="box_card__text--post-meta">
								<span style="margin-bottom:4em; color:#ffffff;">Browse our tour collection for inspiration & select your
									favourite</span>
							</div>
						</div>
					</div>
				...
				<div class="item">
					<div class="box_card " style="background-color: #AC6278;">
						<div class="box_card__text">
							<div class="box_card__text--number">
								<h3 class="box_card__text--number-text">2</h3>
							</div>
							<h3 class="box_card__text--heading" style="color:#ffffff;">Step 2</h3>
							<div class="box_card__text--post-meta">
								<span style="margin-bottom:4em; color:#ffffff;">Book it as it is or request for customization of
									selected tour, </span>
							</div>
						</div>
					</div>
				...
				<div class="item">
					<div class="box_card " style="background-color: #E68473;">
						<div class="box_card__text">
							<div class="box_card__text--number">
								<h3 class="box_card__text--number-text">3</h3>
							</div>
							<h3 class="box_card__text--heading" style="color:#ffffff;">Step 3</h3>
							<div class="box_card__text--post-meta">
								<span style="margin-bottom:4em; color:#ffffff;">Book your trip securely with Sunway Holidays & let us do
									the work.</span>
							</div>
						</div>
					</div>
				...
				<div class="item">
					<div class="box_card " style="background-color: #434463;">
						<div class="box_card__text">
							<div class="box_card__text--number">
								<h3 class="box_card__text--number-text">4</h3>
							</div>
							<h3 class="box_card__text--heading" style="color:#ffffff;">Step 4</h3>
							<div class="box_card__text--post-meta">
								<span style="margin-bottom:4em; color:#ffffff;">Travel stress free & enjoy your fabulous holiday </span>
							</div>
						</div>
					</div>
				</div>
...
<div class="parallax-window mb-3" data-parallax="scroll"
	data-image-src="<?php echo base_url(); ?>assets/images/maldives.jpg"
	style="min-height: 530px; background: transparent;">
	<div class="parallax-box">
		<h2 class="parallax-box--text" style="font-size:2.5em;">Maldives</h2>
		<h3 class="parallax-box--para">Who doesn’t love Maldives, with its sun dipping horizons, sugar soft sandy beaches
			and crystal clear blue water? The perfect destination to combine your Sri Lankan holiday with. It’s also a fine
			destination for watersports. The top notch luxury beach resorts are a treat to your mind, body and soul. Simply
			request for the extension for any of our tours or request a tailor made holiday. Simply request for the extension
			for any of our <strong><a href="<?php echo base_url();?>tour">tours</a></strong> or request a <strong><a
					href="<?php base_url();?>tailormade">tailor made holiday.</a></strong></h3>
	</div>
</div>
...
<section class="ftco-section testimony-section">
	<div class="container">
		...
		<h3 class="sub--para ftco-animate">Travelling solo or want to join a fixed tour? Hop on right in and join us. Select
			& book your favorite (details below) and you are ready to go. </h3>
		<div class="row ftco-animate">
						...
						<div class="card-vacations card-vacations-1">
							<div class="card-vacations__text">
								...
								<div class="card-vacations__text--post-meta">
									<span style="margin-bottom:4em; visibility: hidden;">Lorem ipsum, dolor sit amet consectetur</span>
								</div>
							</div>
						</div>
					</div>
	...
	<div class="tailorMade">
		<div class="tailorMade__container">
			...
			<div class="col-sm-12 group " style="margin-left:auto; margin-right:auto;">
				<a href="<?php echo base_url(); ?>tailormade" class="search-submit btn btn-primary-white bt-4 ftco-animate"
					style="width:220px; font-size:1.5em; margin: auto;">Learn More</a>
			</div>
		</div>
	</div>
</section>
		...
		<div class="row" style="margin-top:6em; margin-bottom: 2em;">
			...
			<div class="col-md-12 col-lg-8 col-sm-12">
				...
				<h4 class="tailorMadePage__para" style='padding-right:2em;'>
					To understand the changing travel patterns and aspirations of the 21st century traveller, accommodate their
					wishes for a most satisfying, memorable holiday for enjoyable, value filled holidays, by treating them as the
					pinnacle of our business, and always trying to delight them, while protecting the culture and traditions of
					our country. We are committed to minimise the environmental impact of each holiday while contributing to the
					sustainability of our destinations

			</div>
			<div class="col-lg-4 col-sm-12 partner"
				style="background-image: url('<?php echo base_url();?>assets/images/partner.jpg'); background-size:contain; background-repeat:no-repeat;">
