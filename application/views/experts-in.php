...
<section class="ftco-section" style="background-color:#dff9fb;">
	<div class="container">
		<div class="row mb-4" style='margin:2em;'>
			<div class="general-section">
				<h1 class="general-section-text">General</h1>
			</div>
		</div>
	</div>
</section>
