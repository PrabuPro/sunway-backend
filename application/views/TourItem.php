	...
	<div class="row">
		...
		<div class="col-lg-9">
			...
			<div class="tour_item-image" style="display:flex; justify-content:flex-end; align-items:flex-end; width:100%; margin-bottom:50px; height:30em; background-size:cover; background-image: url('<?php echo base_url().'assets/images/tours/'.$results->photo_id; ?>');">
				...
				<!-- <div class="panel with-nav-tabs panel-primary col-lg-3">
					<div class="panel-heading">

						<ul class="nav nav-tabs " id="">
							<li class="nav-item active">
								<a class="nav-link active" id="3 star" data-toggle="tab" href="" role="tab" aria-controls=""
								 aria-selected="true">Highlights</a>
							</li>
							<li class="nav-item ">
								<a class="nav-link " id="4 star" data-toggle="tab" href="" role="tab" aria-controls=""
								 aria-selected="false">Tour</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" id="5 star" data-toggle="tab" href="" role="tab" aria-controls=""
				...
				<div class="panel-body col-lg-3">
					<div class="tab-content">
						<div class="tab-content" id="myTabContent">
							<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab" style="width:80%; margin:auto;">
								


							</div>
							<div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab" style="width:80%; margin:auto;">

							</div>
							<div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab" style="width:80%; margin:auto;">
				...
				<div class="panel with-nav-tabs panel-primary">
					<div class="panel-heading">
						...
						<ul class="nav nav-tabs tourTab" id="">
							...
							<li class="nav-item">
								<a class="nav-link" id="inquiry-tab" data-toggle="tab" href="#inquire" role="tab" aria-controls="contact"
						...
						<div class="tab-content" id="myTabContent">
							<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab" style="width:80%; margin:auto;">
								<div class="col-md-12 col-sm-12 ftco-animate">
									...
									<div class="tour_item-image" style="height:30em; background-size:cover; background-image: url('<?php echo base_url().'assets/images/tours/'.$results->map_id; ?>'); margin:auto;">
									</div>
								</div>
									...
									<div class="col-md-12 col-sm-12 ftco-animate">
										...
										<ul class="tours-itinerary">
											...
											<li class="tours-itinerary-item-details">
												<img src="<?php echo base_url(); ?>assets/images/checkmark.png" class="tours-itinerary-icon" alt="">
								...
								<form action="<?php echo site_url('inquirycontroller/tourInquire');?>" method="post" class="tourInquiry_form ftco-animate">
									...
									<div class="row">
										...
										<div class="col-md-6 form-group">
											...
											<input name="country" type="text" class="form-control" value="<?php echo set_value('country');?>"
									...
									<div class="row">
										...
										<div class="col-md-6">
											<label for="number-of-days" style="font-size:14px; margin-bottom:0px; color:#636363; font-weight:600;">Number
									...
									<div class="row">
										<div class="select-wrap col-md-6 group mb-3">
											<label for="hotel_type" style="font-size:14px; margin-bottom:0px; color:#636363; font-weight:600;">Hotel
												Type</label>
