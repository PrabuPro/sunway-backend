<div class="container" style="margin-top:150px;">
	<div class="row">
		...
		<div class="col-lg-8">
			...
			<div class="tour_item-image" style="width:100%; margin-bottom:50px; height:30em; background-size:cover; background-image: url('<?php echo base_url().'assets/images/tours/'.$results->photo_id; ?>');">
			...
			<div class="" style="margin-right:0 !important;">
				...
				<h3 class="sub--para-itenary mb-5 ftco-animate">
